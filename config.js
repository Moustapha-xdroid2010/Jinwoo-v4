...
const defaultOwner = '221757637286';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '221757537286' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '221757537286' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'hiUEFAwI#rnDMMC-FpHMrEyHkETLcP6OFGiHVSETAZBfCRIkiHLI' ;  // put your session id here
